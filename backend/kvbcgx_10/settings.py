"""
Django settings for kvbcgx_10 project.
...
WSGI_APPLICATION = 'kvbcgx_10.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "kvbcgx_10 API",
    "DESCRIPTION": "API documentation for kvbcgx_10 App",
    "VERSION": "v1",
}
